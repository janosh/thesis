...
#canvas({
  ...
  // Label axes
  content(acc, "Accuracy", anchor: "south", padding: 1pt)
  content(speed, "Speed", anchor: "north-east", padding: 1pt)
  content(transfer, "Transferability", anchor: "north-west", padding: 1pt)
